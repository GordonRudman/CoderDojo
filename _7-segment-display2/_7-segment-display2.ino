...
int millisecondsToWaitBeforeChangingNumbers = 500;
...
void loop() 
{
  ...
  {
    flashNumber(0, 5);//Flash the number zero 5 times
    soundTheAlarm();
    //soundTheAlarm2();
  }
...
{ 
  int noteDuration = 10; 
  for (int pitch = 1500; pitch > 120; pitch--)
  {
    tone(buzzerPin, pitch, noteDuration); 
    delay(2);
  } 
